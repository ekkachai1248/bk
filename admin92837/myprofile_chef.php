...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action'] === 'update_user') {
    ...
    if ($stmt->execute()) {
        ...
        echo "<script>swal('', 'อัปเดตข้อมูลสำเร็จ!', 'success'); window.location.href='myprofile_chef.php';</script>";
    } else {
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action'] === 'update_password') {
    ...
    if ($updateStmt->execute()) {
        ...
        echo "<script>swal('', 'เปลี่ยนรหัสผ่านสำเร็จ!', 'success'); window.location.href='myprofile_chef.php';</script>";
    } else {
