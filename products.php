...
<html lang="en">
<head>
	<title>Local Buengkan - Products</title>
	<meta charset="UTF-8">
					...
					<div class="block2">
						...
						<div class="block2-txt flex-w flex-t p-t-14">
							<div class="block2-txt-child1 flex-col-l ">
								<a href="product_detail.php?pid=<?=$row2['p_id'];?>" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-4">
									<?=$row2['p_name'];?>
								</a>
...
<div class="wrap-num-product flex-w m-r-20 m-tb-10">
											...
											<input class="mtext-104 cl3 txt-center num-product" type="number" name="num-product" id="q_product_<?=$row3['p_id'];?>" value="1" min="1" step="1">
								...
								<div class="flex-w flex-r-m p-b-10">
									<div class="size-204 flex-w flex-m respon6-next">
										...
										<button class="flex-c-m stext-101 cl0 size-101 bg1 bor1 hov-btn1 p-lr-15 trans-04 js-addcart-detail" onclick="addToCart(<?=$row3['p_id'];?>, 'q_product_<?=$row3['p_id'];?>')">
											หยิบลงตะกร้า
										</button>
									</div>
								</div>	
