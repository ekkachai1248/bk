...
$stmt = $conn->prepare("SELECT * FROM products AS p INNER JOIN products_category AS pc ON p.pc_id=pc.pc_id  WHERE p.p_id = ?");
...
<?php
    $pictures = explode(";", $row['p_pictures']);
    foreach ($pictures as $picture) {
?>
								<div class="item-slick3" data-thumb="images/products/<?=$picture;?>">
									<div class="wrap-pic-w pos-relative">
										<img src="images/products/<?=$picture;?>" alt="<?=$row['p_name'];?>">
				...
				<div class="col-md-6 col-lg-5 p-b-30">
					<div class="p-r-50 p-t-5 p-lr-0-lg">
						...
						<span class="mtext-106 cl2">
							ราคา <?=number_format($row['p_price'],0);?> บาท
						</span>
...
<div class="wrap-num-product flex-w m-r-20 m-tb-10">
											...
											<input class="mtext-104 cl3 txt-center num-product" type="number" name="num-product" id="q_product_<?=$row['p_id'];?>" value="1" min="1" step="1">
								...
								<div class="flex-w flex-r-m p-b-10">
									<div class="size-204 flex-w flex-m respon6-next">
										...
										<button class="flex-c-m stext-101 cl0 size-101 bg1 bor1 hov-btn1 p-lr-15 trans-04 js-addcart-detail" onclick="addToCart(<?=$row['p_id'];?>, 'q_product_<?=$row['p_id'];?>')">
											หยิบลงตะกร้า
										</button>
									</div>
								</div>	
	...
	<section class="sec-relate-product bg0 p-t-45 p-b-105">
		<div class="container">
			...
			<div class="wrap-slick2">
				<div class="slick2">
<?php
$stmt2 = $conn->prepare("SELECT * FROM `products` ORDER BY RAND() LIMIT 8;");
$stmt2->execute();
$result2 = $stmt2->get_result();
while ($row2 = $result2->fetch_assoc()) {
    $pic = explode(";",$row2['p_pictures']);
?>
					...
					<div class="item-slick2 p-l-15 p-r-15 p-t-15 p-b-15">
						...
						<div class="block2">
							<div class="block2-pic hov-img0">
								<img src="images/products/<?=$pic[0];?>" alt="<?=$row2['p_name'];?>">

								<a href="#" class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04 js-show-modal1" data-target="#md<?=$row2['p_id'];?>">
									Quick View
								</a>
							</div>
...
?>
	<!-- Modal1 -->
	<div class="wrap-modal1 js-modal1 p-t-60 p-b-20" id="md<?=$row3['p_id'];?>">
					...
					<div class="col-md-6 col-lg-7 p-b-30">
						<div class="p-l-25 p-r-30 p-lr-0-lg">
							<div class="wrap-slick3 flex-sb flex-w">
								...
								<div class="slick3 gallery-lb">
<?php
    $pictures = explode(";", $row3['p_pictures']);
    foreach ($pictures as $picture) {
?>                                    
								<div class="item-slick3" data-thumb="images/products/<?=$picture;?>">
									<div class="wrap-pic-w pos-relative">
										<img src="images/products/<?=$picture;?>" alt="<?=$row3['p_name'];?>">
...
<?php } ?>
					...
					<div class="col-md-6 col-lg-5 p-b-30">
						<div class="p-r-50 p-t-5 p-lr-0-lg">
							...
							<span class="mtext-106 cl2">
								ราคา <?=number_format($row3['p_price'],0);?> บาท
							</span>
...
<div class="wrap-num-product flex-w m-r-20 m-tb-10">
											...
											<input class="mtext-104 cl3 txt-center num-product" type="number" name="num-product" id="q_product2_<?=$row3['p_id'];?>" value="1" min="1" step="1">
								...
								<div class="flex-w flex-r-m p-b-10">
									<div class="size-204 flex-w flex-m respon6-next">
										...
										<button class="flex-c-m stext-101 cl0 size-101 bg1 bor1 hov-btn1 p-lr-15 trans-04 js-addcart-detail" onclick="addToCart2(<?=$row3['p_id'];?>, 'q_product2_<?=$row3['p_id'];?>')">
											หยิบลงตะกร้า
										</button>
									</div>
								</div>	
